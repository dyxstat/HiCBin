...
1) Contigs should be assigned to species level with high confidence and accuracy (e.g., 95% ANI/Identity); 
2) Taxonomy file should be in CSV format, where contig name should be in the first column and the species name should be in the seventh column (you can fill in the middle five columns with the same string since they are not used).
